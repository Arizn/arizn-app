...
class FormController extends Controller
{
    ...
    public function addnewform(Request $request)
    {
        ...
        if($request->query('addnew')=='text'){
		 ...
		 if($request->query('addnew')=='venue'){

            return view('_forms.__addvenueform');

        }
		if($request->query('addnew')=='ticket'){

            return view('_forms.__addticketform');

        }
		if($request->query('addnew')=='coupon'){

            return view('_forms.__addcouponform');
        ...
        }else if($request->query('addnew')=='audio'){

            return view('_forms.__addaudioform');

        }else if($request->query('addnew')=='zipfile'){

            return view('_forms.__addzipfileform');
